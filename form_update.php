            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <label for="id_transaksi" style="margin-left:230px;display:inline;">ID Transaksi</label>
                ...
                <div class="form-group">
                  <label for="tanggal" style="margin-left:230px;display:inline;">Tanggal Masuk</label>
                ...
                <div class="form-group">
                  <label for="tanggal_keluar" style="margin-left:230px;display:inline;">Tanggal Keluar</label>
                ...
                <div class="form-group">
                  <label for="nama_pengguna" style="margin-left:230px;display:inline;">Nama Pengguna</label>
                  <input type="text" name="nama_pengguna" style="margin-left:57px;width:20%;display:inline;" class="form-control" required="" placeholder="Masukkan Nama">
                </div>
