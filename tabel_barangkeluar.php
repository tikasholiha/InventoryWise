...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-mini"><b>InventoryWise</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>InventoryWise</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?= base_url('admin')?>">
            <i class="fa fa-dashboard"></i> <span>Dashboard InventoryWise</span>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a href="<?= base_url('export_barang_keluar.php') ?>" style="margin-bottom:10px;"target="_blank" class="btn btn-success mb-3"><i class="far fa-file-excel"></i> Export Excel</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><?=$dd->nama_pengguna?></td>
                    <td><?=$dd->kode_barang?></td>
                    <td><?=$dd->nama_barang?></td>
                    <td><?=$dd->satuan?></td>
                    <td><?=$dd->jumlah?></td>
                    <td><a type="button" class="btn btn-danger btn-delete"  href="<?=base_url('admin/delete_barangkeluar/'.$dd->id_transaksi)?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                </tr>
              <?php $no++; ?>
              <?php endforeach;?>
              <?php }else { ?>
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
              Delete chat history
              <a href="javascript:void(0)" class="text-green pull-right"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
